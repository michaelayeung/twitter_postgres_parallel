...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/michaelayeung/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/michaelayeung/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/michaelayeung/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/michaelayeung/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/michaelayeung/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/michaelayeung/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |        8m13.283s          |         1m15.967s         | 
| `pg_normalized_batch`  |        3m32.915s          |         0m16.054s         | 
| `pg_denormalized`      |        0m22.191s          |         0m2.857s          | 
